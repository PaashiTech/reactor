...
const DEFAULT_TINT_COLOR: string = "#FDDC69";
const DEFAULT_OFF_TINT_COLOR: string = "#E5E0DF";
...
export class OTPTextView extends Component<IProps, IState> {
  ...
  onInputFocus = (i: number) => {
    ...
    const correctIndex = otpText.filter((e) => e).length;
    if (correctIndex < i) {
      this.inputs[correctIndex].focus();
      return;
    }
