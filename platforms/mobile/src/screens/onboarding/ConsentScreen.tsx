...
export const _ConsentScreen: React.FC<ConsentScreenProps> = ({
  ...
  return (
    <View flex={1} {...safeAreaInsets} jc="space-between">
      <View flex={1}>
        <CustomHeader title="Consent Details" />
        <SharedProgressbar value={80} sharedTransitionTag="sharedTag" />
        <ScrollView
      ...
      <SaafeFooter>
        <View>
          ...
          <View mt={12} flexDirection="row" gap={12}>
            ...
            <View flexGrow={1}>
              <UnmzGradientButton onPress={handleApprove}>
                Approve
              </UnmzGradientButton>
            </View>
          </View>
